...
extension DeviceLcdGs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularFixed32Field(value: &self._lcdGsStartHour)
      case 2: try decoder.decodeSingularFixed32Field(value: &self._lcdGsEndHour)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._lcdGsStartHour {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 1)
    }
    if let v = self._lcdGsEndHour {
...
extension HealthDataConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBoolField(value: &self._ecgConfig)
      case 2: try decoder.decodeSingularBoolField(value: &self._fatigueConfig)
      case 3: try decoder.decodeSingularBoolField(value: &self._bpConfig)
      case 4: try decoder.decodeSingularBoolField(value: &self._afConfig)
      case 5: try decoder.decodeSingularBoolField(value: &self._biozConfig)
      case 6: try decoder.decodeSingularBoolField(value: &self._moodConfig)
      case 7: try decoder.decodeSingularBoolField(value: &self._breathrateConfig)
      case 8: try decoder.decodeSingularBoolField(value: &self._mdtConfig)
      case 9: try decoder.decodeSingularBoolField(value: &self._spo2Config)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._ecgConfig {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 1)
    }
    if let v = self._fatigueConfig {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 2)
    }
    if let v = self._bpConfig {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 3)
    }
    if let v = self._afConfig {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 4)
    }
    if let v = self._biozConfig {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 5)
    }
    if let v = self._moodConfig {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 6)
    }
    if let v = self._breathrateConfig {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 7)
    }
    if let v = self._mdtConfig {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 8)
    }
    if let v = self._spo2Config {
...
extension DeviceConfNotification: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularEnumField(value: &_storage._languageID)
        case 3: try decoder.decodeSingularBoolField(value: &_storage._lcdGsSwitch)
        case 4: try decoder.decodeSingularMessageField(value: &_storage._lcdGsTime)
        case 5: try decoder.decodeSingularBoolField(value: &_storage._distanceUnit)
        case 6: try decoder.decodeSingularBoolField(value: &_storage._temperatureUnit)
        case 7: try decoder.decodeSingularBoolField(value: &_storage._hourFormat)
        case 8: try decoder.decodeSingularBoolField(value: &_storage._dateFormat)
        case 9: try decoder.decodeSingularBoolField(value: &_storage._autoHeartrate)
        case 10: try decoder.decodeSingularBoolField(value: &_storage._autoSport)
        case 11: try decoder.decodeSingularBoolField(value: &_storage._habitualHand)
        case 12: try decoder.decodeSingularStringField(value: &_storage._nickName)
        case 13: try decoder.decodeSingularBoolField(value: &_storage._autoAllsensor)
        case 14: try decoder.decodeSingularMessageField(value: &_storage._heathConfig)
        case 15: try decoder.decodeSingularBoolField(value: &_storage._healthSleep)
        case 16: try decoder.decodeSingularFixed32Field(value: &_storage._backlightTime)
        case 17: try decoder.decodeSingularFixed32Field(value: &_storage._gestureSensitivity)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._languageID {
        try visitor.visitSingularEnumField(value: v, fieldNumber: 2)
      }
      if let v = _storage._lcdGsSwitch {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 3)
      }
      if let v = _storage._lcdGsTime {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
      }
      if let v = _storage._distanceUnit {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 5)
      }
      if let v = _storage._temperatureUnit {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 6)
      }
      if let v = _storage._hourFormat {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 7)
      }
      if let v = _storage._dateFormat {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 8)
      }
      if let v = _storage._autoHeartrate {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 9)
      }
      if let v = _storage._autoSport {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 10)
      }
      if let v = _storage._habitualHand {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 11)
      }
      if let v = _storage._nickName {
        try visitor.visitSingularStringField(value: v, fieldNumber: 12)
      }
      if let v = _storage._autoAllsensor {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 13)
      }
      if let v = _storage._heathConfig {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 14)
      }
      if let v = _storage._healthSleep {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 15)
      }
      if let v = _storage._backlightTime {
        try visitor.visitSingularFixed32Field(value: v, fieldNumber: 16)
      }
      if let v = _storage._gestureSensitivity {
...
extension DeviceConfSubscriber: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeSingularFixed32Field(value: &_storage._hash)
        case 2: try decoder.decodeRepeatedFixed32Field(value: &_storage._supportLanguageMask)
        case 3: try decoder.decodeSingularBoolField(value: &_storage._supportLcdGestureSwitch)
        case 4: try decoder.decodeSingularBoolField(value: &_storage._supportLcdGestureTime)
        case 5: try decoder.decodeSingularBoolField(value: &_storage._supportDistanceUnit)
        case 6: try decoder.decodeSingularBoolField(value: &_storage._supportTemperatureUnit)
        case 7: try decoder.decodeSingularBoolField(value: &_storage._supportHourFormat)
        case 8: try decoder.decodeSingularBoolField(value: &_storage._supportDateFormat)
        case 9: try decoder.decodeSingularBoolField(value: &_storage._supportAutoHeartrate)
        case 10: try decoder.decodeSingularBoolField(value: &_storage._supportAutoSport)
        case 11: try decoder.decodeSingularBoolField(value: &_storage._supportHabitualHand)
        case 12: try decoder.decodeSingularBoolField(value: &_storage._supportNickName)
        case 13: try decoder.decodeSingularBoolField(value: &_storage._supportAutoAllsensor)
        case 14: try decoder.decodeSingularBoolField(value: &_storage._supportHeathConfig)
        case 15: try decoder.decodeSingularBoolField(value: &_storage._supportHealthSleep)
        case 16: try decoder.decodeSingularBoolField(value: &_storage._supportBacklightTime)
        case 17: try decoder.decodeSingularBoolField(value: &_storage._supportGestureSensitivity)
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._supportLcdGestureSwitch {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 3)
      }
      if let v = _storage._supportLcdGestureTime {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 4)
      }
      if let v = _storage._supportDistanceUnit {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 5)
      }
      if let v = _storage._supportTemperatureUnit {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 6)
      }
      if let v = _storage._supportHourFormat {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 7)
      }
      if let v = _storage._supportDateFormat {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 8)
      }
      if let v = _storage._supportAutoHeartrate {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 9)
      }
      if let v = _storage._supportAutoSport {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 10)
      }
      if let v = _storage._supportHabitualHand {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 11)
      }
      if let v = _storage._supportNickName {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 12)
      }
      if let v = _storage._supportAutoAllsensor {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 13)
      }
      if let v = _storage._supportHeathConfig {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 14)
      }
      if let v = _storage._supportHealthSleep {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 15)
      }
      if let v = _storage._supportBacklightTime {
        try visitor.visitSingularBoolField(value: v, fieldNumber: 16)
      }
      if let v = _storage._supportGestureSensitivity {
