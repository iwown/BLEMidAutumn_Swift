...
struct SedtNotification {
  ...
  var group: SedtGroup {
    get {return _storage._group ?? SedtGroup()}
...
struct SedtSubscriber {
  ...
  var confirm: SedtConfirm {
    get {return _storage._confirm ?? SedtConfirm()}
...
extension Sedentariness: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBoolField(value: &self._repeat)
      case 2: try decoder.decodeSingularBoolField(value: &self._monday)
      case 3: try decoder.decodeSingularBoolField(value: &self._tuesday)
      case 4: try decoder.decodeSingularBoolField(value: &self._wednesday)
      case 5: try decoder.decodeSingularBoolField(value: &self._thursday)
      case 6: try decoder.decodeSingularBoolField(value: &self._friday)
      case 7: try decoder.decodeSingularBoolField(value: &self._saturday)
      case 8: try decoder.decodeSingularBoolField(value: &self._sunday)
      case 9: try decoder.decodeSingularFixed32Field(value: &self._startHour)
      case 10: try decoder.decodeSingularFixed32Field(value: &self._endHour)
      case 11: try decoder.decodeSingularFixed32Field(value: &self._duration)
      case 12: try decoder.decodeSingularFixed32Field(value: &self._threshold)
      default: break
      }
    }
  }
...
extension SedtGroup: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedMessageField(value: &self.sedentariness)
      default: break
      }
    }
  }
...
extension SedtNotification: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _operation: SedtOperation? = nil
    var _group: SedtGroup? = nil
