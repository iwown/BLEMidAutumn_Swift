...
extension ConParamsUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularFixed32Field(value: &self._mtu)
      case 2: try decoder.decodeSingularFixed32Field(value: &self._intervalMs)
      case 3: try decoder.decodeSingularFixed32Field(value: &self._timeoutMs)
      case 4: try decoder.decodeSingularFixed32Field(value: &self._maxSize)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._intervalMs {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 2)
    }
    if let v = self._timeoutMs {
