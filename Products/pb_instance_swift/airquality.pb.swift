...
struct AirQualityNotification {
  ...
  var airdata: AirQualityData {
    get {return _storage._airdata ?? AirQualityData()}
    set {_uniqueStorage()._airdata = newValue}
  }
  /// Returns true if `airdata` has been explicitly set.
  var hasAirdata: Bool {return _storage._airdata != nil}
  /// Clears the value of `airdata`. Subsequent reads from it will return its default value.
  mutating func clearAirdata() {_uniqueStorage()._airdata = nil}
...
extension AirQualityData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularFixed32Field(value: &self._pm2P5)
      case 2: try decoder.decodeSingularFixed32Field(value: &self._pm10)
      case 3: try decoder.decodeSingularFixed32Field(value: &self._aqi)
      case 4: try decoder.decodeSingularFixed32Field(value: &self._o3)
      case 5: try decoder.decodeSingularFixed32Field(value: &self._no2)
      case 6: try decoder.decodeSingularFixed32Field(value: &self._so2)
      case 7: try decoder.decodeSingularFixed32Field(value: &self._co)
      case 8: try decoder.decodeSingularFixed32Field(value: &self._country)
      default: break
      }
    }
  }
...
extension AirQualityNotification: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _operation: AirQualityOperation? = nil
    var _airdata: AirQualityData? = nil
  ...
  public var isInitialized: Bool {
    return withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._airdata, !v.isInitialized {return false}
      return true
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularMessageField(value: &_storage._airdata)
        default: break
        }
      }
    }
  ...
  static func ==(lhs: AirQualityNotification, rhs: AirQualityNotification) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._airdata != rhs_storage._airdata {return false}
        return true
      }
