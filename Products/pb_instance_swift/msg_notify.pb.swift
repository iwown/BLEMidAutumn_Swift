...
struct MsgHandler {
  ...
  var policy: MsgHandler.Policy {
    get {return _storage._policy ?? .storeAndPrompt}
  ...
  var timing: MsgHandler.Timing {
    get {return _storage._timing ?? MsgHandler.Timing()}
    set {_uniqueStorage()._timing = newValue}
  }
  /// Returns true if `timing` has been explicitly set.
  var hasTiming: Bool {return _storage._timing != nil}
...
struct MsgNotify {
  ...
  var type: MsgNotify.TypeEnum {
    get {return _storage._type ?? .call}
  ...
  var status: MsgNotify.Status {
    get {return _storage._status ?? .added}
  ...
  var option: MsgNotify.Option {
    get {return _storage._option ?? MsgNotify.Option()}
...
struct MsgNotification {
  ...
  var handler: MsgHandler {
    get {
      if case .handler(let v)? = _storage._params {return v}
      return MsgHandler()
    }
    set {_uniqueStorage()._params = .handler(newValue)}
  }

  var filter: MsgFilter {
    get {
      if case .filter(let v)? = _storage._params {return v}
      return MsgFilter()
    }
    set {_uniqueStorage()._params = .filter(newValue)}
  }

  var notify: MsgNotify {
    get {
      if case .notify(let v)? = _storage._params {return v}
      return MsgNotify()
    }
    set {_uniqueStorage()._params = .notify(newValue)}
  }
  ...
  enum OneOf_Params: Equatable {
    ...
    static func ==(lhs: MsgNotification.OneOf_Params, rhs: MsgNotification.OneOf_Params) -> Bool {
      switch (lhs, rhs) {
      case (.handler(let l), .handler(let r)): return l == r
...
struct MsgSubscriber {
  ...
  var operation: MsgOperation {
    get {
      if case .operation(let v)? = _storage._data {return v}
      return MsgOperation()
    }
    set {_uniqueStorage()._data = .operation(newValue)}
  }
...
extension MsgHandler: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _policy: MsgHandler.Policy? = nil
    var _timing: MsgHandler.Timing? = nil
  ...
  public var isInitialized: Bool {
    return withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._policy == nil {return false}
      if _storage._timing == nil {return false}
      if let v = _storage._timing, !v.isInitialized {return false}
      return true
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try decoder.decodeSingularEnumField(value: &_storage._policy)
        case 3: try decoder.decodeSingularMessageField(value: &_storage._timing)
        default: break
        }
      }
    }
...
extension MsgHandler.Timing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularFixed32Field(value: &self._startHour)
      case 2: try decoder.decodeSingularFixed32Field(value: &self._startMinute)
      case 3: try decoder.decodeSingularFixed32Field(value: &self._endHour)
      case 4: try decoder.decodeSingularFixed32Field(value: &self._endMinute)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._startHour {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 1)
    }
    if let v = self._startMinute {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 2)
    }
    if let v = self._endHour {
...
extension MsgFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedMessageField(value: &self.id)
      default: break
      }
    }
  }
...
extension MsgNotify: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _id: UInt32? = nil
    var _type: MsgNotify.TypeEnum? = nil
    var _status: MsgNotify.Status? = nil
    var _option: MsgNotify.Option? = nil
  ...
  public var isInitialized: Bool {
    return withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._option == nil {return false}
      if _storage._title == nil {return false}
      if _storage._detail == nil {return false}
      if let v = _storage._option, !v.isInitialized {return false}
      return true
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try decoder.decodeSingularMessageField(value: &_storage._option)
        case 5: try decoder.decodeSingularStringField(value: &_storage._title)
        case 6: try decoder.decodeSingularStringField(value: &_storage._detail)
        default: break
        }
      }
    }
...
extension MsgNotify.Option: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularBoolField(value: &self._reject)
      case 3: try decoder.decodeSingularBoolField(value: &self._mute)
      default: break
      }
    }
  }
...
extension MsgNotification: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _params: MsgNotification.OneOf_Params?
  ...
  public var isInitialized: Bool {
    return withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .handler(let v)?: if !v.isInitialized {return false}
      case .filter(let v)?: if !v.isInitialized {return false}
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 1:
          ...
          if let v = v {_storage._params = .handler(v)}
        case 2:
          var v: MsgFilter?
          if let current = _storage._params {
            try decoder.handleConflictingOneOf()
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._params = .filter(v)}
        case 3:
          var v: MsgNotify?
          if let current = _storage._params {
            try decoder.handleConflictingOneOf()
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._params = .notify(v)}
        default: break
        }
      }
    }
...
extension MsgRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBoolField(value: &self._supportHandler)
      case 2: try decoder.decodeSingularBoolField(value: &self._supportFilter)
      case 3: try decoder.decodeSingularBoolField(value: &self._supportNotify)
      case 4: try decoder.decodeSingularFixed32Field(value: &self._handlerHash)
      case 5: try decoder.decodeSingularFixed32Field(value: &self._filterHash)
      case 6: try decoder.decodeSingularFixed32Field(value: &self._filterIDCount)
      case 7: try decoder.decodeSingularFixed32Field(value: &self._notifyTitleLen)
      case 8: try decoder.decodeSingularFixed32Field(value: &self._notifyDetailLen)
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._supportHandler {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 1)
    }
    if let v = self._supportFilter {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 2)
    }
    if let v = self._supportNotify {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 3)
    }
    if let v = self._handlerHash {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 4)
    }
    if let v = self._filterHash {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 5)
    }
    if let v = self._filterIDCount {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 6)
    }
    if let v = self._notifyTitleLen {
      try visitor.visitSingularFixed32Field(value: v, fieldNumber: 7)
    }
    if let v = self._notifyDetailLen {
...
extension MsgOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularEnumField(value: &self._option)
      default: break
      }
    }
  }
...
extension MsgSubscriber: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _data: MsgSubscriber.OneOf_Data?
  ...
  public var isInitialized: Bool {
    return withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .operation(let v)?: if !v.isInitialized {return false}
      default: break
      }
      return true
    }
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2:
          ...
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._data = .operation(v)}
        default: break
        }
      }
    }
